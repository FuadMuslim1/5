                    ...
                    <form onSubmit={handleSendAchievement} className="space-y-4">
                        <div>
                            ...
                            <input type="email" required value={achForm.email} onChange={e => setAchForm({...achForm, email: e.target.value})}
                                className="w-full p-3 rounded-lg border border-slate-200 bg-slate-50 outline-none text-sm" placeholder="user@email.com" title="Email User" />
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" required value={achForm.title} onChange={e => setAchForm({...achForm, title: e.target.value})}
                                    className="w-full p-3 rounded-lg border border-slate-200 bg-slate-50 outline-none text-sm" title="Event Title" />
                            </div>
                            <div>
                                ...
                                <input type="number" required value={achForm.amount} onChange={e => setAchForm({...achForm, amount: e.target.value})}
                                    className="w-full p-3 rounded-lg border border-slate-200 bg-slate-50 outline-none text-sm font-bold" title="Amount in Rupiah" />
                            </div>
                        </div>
                        <div>
                            <label className="text-xs font-bold text-slate-500 uppercase">Description</label>
                            <textarea value={achForm.description} onChange={e => setAchForm({...achForm, description: e.target.value})}
                                className="w-full p-3 rounded-lg border border-slate-200 bg-slate-50 outline-none text-sm h-24" placeholder="Deskripsi..." title="Deskripsi Event Reward" />
                        </div>
