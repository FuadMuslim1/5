...
const PronunciationMenu = React.lazy(() => import('./pages/PronunciationMenu').then(m => ({ default: m.default })));
...
const Reward = React.lazy(() => import('./pages/Reward').then(m => ({ default: m.Reward })));
const Tutorial = React.lazy(() => import('./pages/Tutorial').then(m => ({ default: m.Tutorial })));
const SkillMenu = React.lazy(() => import('./pages/SkillMenu').then(m => ({ default: m.SkillMenu })));
const Symbol = React.lazy(() => import('./pages/Symbol').then(m => ({ default: m.default })));
const PronunciationSymbol = React.lazy(() => import('./pages/pronunciation/symbol/PronunciationSymbol').then(m => ({ default: m.default })));
      ...
      <HashRouter>
        <Suspense fallback={<LoadingScreen />}>
          <Routes>
            ...
            <Route path="/progress" element={<ProtectedRoute><Progress user={authState.user!} /></ProtectedRoute>} />
            <Route path="/reward" element={<ProtectedRoute><Reward user={authState.user!} /></ProtectedRoute>} />
            <Route path="/tutorial" element={<ProtectedRoute><Tutorial user={authState.user!} /></ProtectedRoute>} />
            <Route path="/skill-menu" element={<ProtectedRoute><SkillMenu user={authState.user!} /></ProtectedRoute>} />
            <Route path="/symbol" element={<ProtectedRoute><Symbol /></ProtectedRoute>} />
            <Route path="/pronunciation/symbol/:symbol" element={<ProtectedRoute><PronunciationSymbol /></ProtectedRoute>} />
